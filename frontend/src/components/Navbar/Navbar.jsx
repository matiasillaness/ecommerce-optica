    ...
    return (
        ...
        <div className="flex justify-around items-center w-screen bg-emerald-500">
            <div>
                ...
                <img className="p-2 w-32 h-auto max-w-full rounded-lg " src="../src/assets/optica_colon-removebg-preview.png" alt="elpeep" />
            ...
            <div className="">
                ...
                <form action="">
                    ...
                    <div className="flex bg-white rounded-md ">
                        ...
                        <input className="rounded-md ml-2" type="text" placeholder="Buscar productos" />

                        <div className="flex">

                            <button className="" type="submit" aria-label="Buscar en">

                                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="10" height="10" viewBox="0 0 26 26">
